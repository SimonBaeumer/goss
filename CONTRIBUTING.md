...
> At first thank you for considering contributing to goss. 

### Get in touch

 - Report bugs or feature requests on [github](https://github.com/SimonBaeumer/goss/issues)
 - Start with `good first issue` in the github issues
 - Fixing typos and improving documentation is always very welcoming
